                        ...
                        <div className="contact-split-layout">
                            ...
                            <div className="contact-editorial" data-animate="left">
                                ...
                                <p className="contact-subhead">
                                    Whether you're bringing a delegation, looking to partner,
                                    or just have a few questions — we’re here to help.
                                </p>
                            ...
                            <div className="contact-staggered-cards" data-animate-stagger>
                                ...
                                <div className="contact-card" data-animate>
                                    ...
                                    <h3 className="contact-card-title">Join as a Delegate</h3>
                                    <p className="contact-card-desc">
                                        Secure your spot for a weekend of policy drafting and real-world impact. We cap at 250 delegates.
                                    </p>
                                    <a
                                ...
                                <div className="contact-card contact-card-offset" data-animate>
                                    <div className="custom-editorial-icon">
                                        <svg viewBox="0 0 100 100" className="icon-vector" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            {/* Hand drawn blob base - different shape */}
                                            ...
                                            {/* Intersecting rings representing partnership */}
                                    ...
                                    <p className="contact-card-desc">
                                        Help us support the Thai Red Cross. See our tiers, benefits, and how your brand can assist.
                                    </p>
